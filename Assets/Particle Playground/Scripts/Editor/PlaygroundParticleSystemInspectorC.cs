...
class PlaygroundParticleSystemInspectorC : Editor {
	...
	public override void OnInspectorGUI () {
		...
		if (particlesFoldout) {
			...
			// Advanced Settings
			if (GUILayout.Button("Advanced ("+playgroundParticlesScriptReference.GetComponent<ParticleSystem>().simulationSpace+" Space)", EditorStyles.toolbarDropDown)) advancedFoldout=!advancedFoldout;
			if (advancedFoldout) {
				...
				playgroundParticlesScriptReference.GetComponent<ParticleSystem>().simulationSpace = (ParticleSystemSimulationSpace)EditorGUILayout.EnumPopup("Simulation Space", playgroundParticlesScriptReference.GetComponent<ParticleSystem>().simulationSpace);
				GUI.enabled = true;
