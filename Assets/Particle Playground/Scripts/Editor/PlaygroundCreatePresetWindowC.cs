...
class PlaygroundCreatePresetWindowC : EditorWindow {
	...
	public void RefreshFromPresetList () {
		...
		particleSystemIcon = AssetDatabase.LoadAssetAtPath(PlaygroundParticleWindowC.playgroundPath+PlaygroundParticleWindowC.iconPath+PlaygroundParticleWindowC.presetNames[selectedPreset]+".png", typeof(Texture2D)) as Texture2D;
